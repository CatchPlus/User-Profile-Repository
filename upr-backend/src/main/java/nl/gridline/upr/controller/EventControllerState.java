 ...
 * EventControllerState.java created 8 dec. 2011
 * <p />
...
public class EventControllerState extends ServerState
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -304996662780896155L;
	@XmlElement(name = "description")
	private static final String description = "server status message, the structure of this message may change anytime";

	public EventControllerState()
	{
		// no-arg constructor
	}
